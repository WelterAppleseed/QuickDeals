...
public class AlternativeWeeklyDealsContainerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new AlternativeWeeklyRecyclerItemAdapter(context, titles, timelessReminderEntities, LocalDate.now());
        rList = view.findViewById(R.id.item_layout);
        rList.setLayoutManager(new LinearLayoutManager(context));
        rList.setAdapter(adapter);
        WeeklyReminderDCC.setAltWeekAdapter(adapter);
        ItemTouchCallbacks.setAltWeekAdapter(adapter);
        return view;
    }
}
